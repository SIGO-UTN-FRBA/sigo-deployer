...
INSERT INTO public.tbl_placed_object(object_id, height_agl, height_amls, lighting, mark_indicator,name, subtype, temporary, type, verified,  owner_id, location_id)
VALUES (4, 20, 50, 9, 5, 'Galpon 1', 'Galpon', FALSE, 2,TRUE, 1, 101);


INSERT INTO public.tbl_placed_object_building_spec(spec_id,geom,object_id)
VALUES (1,
ST_GeomFromGeoJSON('{"type":"Polygon","coordinates":[[[-58.538256883621216,-34.81768777397881],[-58.53860020637512,-34.817969632202775],[-58.538385629653924,-34.81814579310304],[-58.53833198547363,-34.81818983326926],[-58.53817105293274,-34.81804890465451],[-58.53806376457214,-34.81791678385923],[-58.537999391555786,-34.817881551611364],[-58.53812813758851,-34.81777585477738],[-58.538256883621216,-34.81768777397881]]]}'),4);


INSERT INTO public.tbl_placed_object(object_id, height_agl, height_amls, lighting, mark_indicator,name, subtype, temporary, type, verified,  owner_id, location_id)
VALUES (5, 20, 40, 9, 5, 'Galpon 2', 'Galpon', FALSE, 2,TRUE, 1, 101);
